...
public class InstitutionCommentView extends BaseView implements IInstitutionCommentView {
	...
	interface ModuleUiBinder extends UiBinder<Widget, InstitutionCommentView> {}
