...
public class HospitalProfileBranchView extends BaseView {
	
	@UiField
	FlowPanel branchesPanel;
	
	interface ModuleUiBinder extends UiBinder<Widget, HospitalProfileBranchView> {}
	
	private static ModuleUiBinder uiBinder = GWT.create(ModuleUiBinder.class);
	
	InstitutionBean institutionBean;
	
	public HospitalProfileBranchView() {
