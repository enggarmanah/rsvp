...
public class HospitalProfileView extends BaseView implements IHospitalProfileView {
	...
	private HospitalProfileLocationView locationView = new HospitalProfileLocationView();
	
	private HospitalProfileServiceView serviceView = new HospitalProfileServiceView();
	
	private HospitalProfileDoctorView doctorView = new HospitalProfileDoctorView();
	
	private HospitalProfileGalleryView galleryView = new HospitalProfileGalleryView();
	
	private HospitalProfileBranchView branchView = new HospitalProfileBranchView();
	
	interface ModuleUiBinder extends UiBinder<Widget, HospitalProfileView> {}
