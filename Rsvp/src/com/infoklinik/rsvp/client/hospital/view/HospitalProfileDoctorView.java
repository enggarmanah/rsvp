...
public class HospitalProfileDoctorView extends BaseView {
	
	@UiField
	FlowPanel doctorsPanel;
	
	interface ModuleUiBinder extends UiBinder<Widget, HospitalProfileDoctorView> {}
	...
	public HospitalProfileDoctorView() {
