...
import com.infoklinik.rsvp.client.clinic.presenter.interfaces.IClinicSearchView;
import com.infoklinik.rsvp.client.clinic.view.ClinicSearchView;
...
public class ClinicSearchPresenter extends LazyPresenter<IClinicSearchView, ClinicEventBus> implements LocationListener {
