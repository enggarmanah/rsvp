package com.infoklinik.rsvp.client.clinic.presenter;
...
import com.infoklinik.rsvp.client.clinic.ClinicEventBus;
import com.infoklinik.rsvp.client.clinic.presenter.interfaces.IClinicProfileView;
import com.infoklinik.rsvp.client.clinic.view.ClinicProfileView;
...
@Singleton
@Presenter(view = ClinicProfileView.class)
public class ClinicProfilePresenter extends LazyPresenter<IClinicProfileView, ClinicEventBus> {
	...
	public void onLoadClinicProfile(InstitutionBean institution) {
