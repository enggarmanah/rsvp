...
import com.infoklinik.rsvp.client.clinic.presenter.interfaces.IClinicProfileView;
...
public class ClinicProfileView extends BaseView implements IClinicProfileView {
	...
	private ClinicProfileLocationView locationView = new ClinicProfileLocationView();
	
	private ClinicProfileServiceView serviceView = new ClinicProfileServiceView();
	
	private ClinicProfileDoctorView doctorView = new ClinicProfileDoctorView();
	
	private ClinicProfileGalleryView galleryView = new ClinicProfileGalleryView();
	
	private ClinicProfileBranchView branchView = new ClinicProfileBranchView();
	
	interface ModuleUiBinder extends UiBinder<Widget, ClinicProfileView> {}
