...
public class ClinicProfileGalleryView extends BaseView {
	...
	interface ModuleUiBinder extends UiBinder<Widget, ClinicProfileGalleryView> {}
	
	private static ModuleUiBinder uiBinder = GWT.create(ModuleUiBinder.class);
	
	List<GalleryBean> galleries;
	
	public ClinicProfileGalleryView() {
