...
public class ClinicProfileServiceView extends BaseView {
	...
	interface ModuleUiBinder extends UiBinder<Widget, ClinicProfileServiceView> {}
	...
	public ClinicProfileServiceView() {
