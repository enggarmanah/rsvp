...
import com.infoklinik.rsvp.client.lab.view.LabProfileView;
...
@Singleton
@Presenter(view = LabProfileView.class)
public class LabProfilePresenter extends LazyPresenter<ILabProfileView, LabEventBus> {
	...
	public void onLoadLabProfile(InstitutionBean institution) {
