...
public class LabProfileLocationView extends BaseView {
	
	interface ModuleUiBinder extends UiBinder<Widget, LabProfileLocationView> {}
	
	private static ModuleUiBinder uiBinder = GWT.create(ModuleUiBinder.class);
	
	InstitutionBean institution;
	
	public LabProfileLocationView() {
