...
import com.infoklinik.rsvp.client.inst.view.InstitutionProfileView;
...
@Singleton
@Presenter(view = InstitutionProfileView.class)
public class InstitutionProfilePresenter extends LazyPresenter<IInstitutionProfileView, InstitutionEventBus> {
	...
	public void onLoadInstitutionProfile(InstitutionBean institution) {
