...
public class InstitutionProfileGalleryView extends BaseView {
	...
	interface ModuleUiBinder extends UiBinder<Widget, InstitutionProfileGalleryView> {}
	
	private static ModuleUiBinder uiBinder = GWT.create(ModuleUiBinder.class);
	
	List<GalleryBean> galleries;
	
	public InstitutionProfileGalleryView() {
