...
public class InstitutionProfileDoctorView extends BaseView {
	
	@UiField
	FlowPanel doctorsPanel;
	
	interface ModuleUiBinder extends UiBinder<Widget, InstitutionProfileDoctorView> {}
	...
	public InstitutionProfileDoctorView() {
