...
import com.infoklinik.rsvp.client.search.view.PharmacySearchView;
...
@Singleton
@Presenter(view = PharmacySearchView.class)
public class PharmacySearchPresenter extends LazyPresenter<IPharmacySearchView, SearchEventBus> implements LocationListener {
	...
	private PharmacySearchPresenter labSearchPresenter;
	...
	public void onLoadPharmacySearch() {
	...
	public void onRemovePharmacySearch() {
